...
class Events:
    ...
    def add_key_event(self, key: str, event_id: any, event_type):
        self.__all_events.append(Keyboard(key, event_type, event_id))

    def add_mouse_event(self, button: str, event_id: any, event_type):
        self.__all_events.append(Mouse(button, event_type, event_id))
